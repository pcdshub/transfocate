...
tfs = tf.MFXTransfocator(prefix='MFX:LENS', name='MFX Transfocator')

c = calc.TFS_Calculator(tfs.tfs_lenses, prefocus_lenses=tfs.xrt_lenses)
...
# c = calc.TFS_Calculator(lenses, prefocus_lenses=tfs.xrt_lenses)
